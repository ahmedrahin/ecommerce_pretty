<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('serviceedit', $data->id) }}
    @endsection
    ...
    <!--begin::Form-->
    <form class="form" id="add_order_form" method="POST" action="{{ route('service.update', $data->id) }}">
        @csrf
                ...
                <div class="card-body pt-5">
                    ...
                    <div class="d-flex flex-column gap-5 gap-md-7">
                        ...
                        <div class="d-flex flex-column flex-md-row gap-5">
                            ...
                            <div class="flex-row-fluid">
                                <label class="required form-label">Service Cost</label>
                                <input placeholder="1000" name="service_cost" class="form-control mb-2" value="{{ $data->service_cost }}" />
                                <div id="service_cost" class="text-danger"></div>
                            </div>
                            <div class="flex-row-fluid">
                                <label class=" form-label">Status</label>
                                <input placeholder="status" name="status" class="form-control mb-2" value="{{ $data->status }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-0">
                            <div class="card radius-10 w-100">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-light-success btn-sm mt-3"
                        ...
                        <div class="d-flex justify-content-end" style="margin-top: 15px;">
                            <button type="submit" id="add_order" class="btn btn-primary" style="width: 200px;">
                                <span class="indicator-label">Save Servicing</span>
