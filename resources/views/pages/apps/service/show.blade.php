...
<head>
  ...
  <style>
    ...
    .font-semibold,.font-mono,.text-gray-900 {
      font-size: 14px;
    }
    .font-medium{
      font-size: 12px;
...
<body class="p-4 bg-gray-50 text-gray-800">
  ...
  <div class="bg-white p-6 max-w-4xl mx-auto shadow-lg border border-gray-200 relative" id="body-part">
      ...
      <div class="relative z-10">
        <div class="flex justify-between items-center">
          ...
          <div class="text-right">
            <div class="text-2xl font-bold mb-1">SERVICING RECEIPT</div>
          </div>
        </div>
      ...
      <div class="grid grid-cols-2 gap-6 mb-4">
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center">
            ...
            <div class="text-gray-900">{{ Carbon\Carbon::parse($data->date_of)->format('d M, Y') ?? '' }}</div>
          </div>
          <div class="flex items-center">
            <div class="w-32 font-semibold text-gray-700">Servicing Cost:</div>
            <div class="text-gray-900">{{ format_price($data->service_cost) ?? '' }}</div>
          </div>
        </div>
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center">
            ...
            <div class="text-gray-900 font-medium">{{ Carbon\Carbon::parse($data->date_of)->format('d-M-Y') ?? '' }}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="mb-6">
     ...
     <div class="warranty">
        {!! App\Models\PagesContent::value('servicing_text') !!}
      </div>

    <div class="flex justify-between mt-14 gap-20">
      ...
      <div class="flex justify-center items-center space-x-6">
        <div class="flex items-center">
          <svg class="w-4 h-4 mr-1 text-blue-600" fill="currentColor" viewBox="0 0 512 512">
            <path d="M279.14 288l14.22-92.66h-88.91V117.33c0-25.35 12.42-50.06 52.24-50.06H295V6.26S259.5 0 225.36 0c-73.22 0-121.14 44.38-121.14 124.72V195.3H22.89V288h81.33v224h100.2V288z"/>
          </svg>
          srlaptopshowroomraj
        </div>
        <div class="flex items-center">
          <svg class="w-4 h-4 mr-1 text-green-600" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 2a10 10 0 100 20 10 10 0 000-20zm6.93 6h-2.07a15.9 15.9 0 00-1.1-3.12A8.02 8.02 0 0118.93 8zM12 4c.86 0 1.95 2.1 2.63 5H9.37C10.05 6.1 11.14 4 12 4zm-4.86 0.88A15.9 15.9 0 006.04 8H3.97A8.02 8.02 0 017.14 4.88zM4.07 16h2.07c.3 1.12.72 2.1 1.1 3.12A8.02 8.02 0 013.97 16zM12 20c-.86 0-1.95-2.1-2.63-5h5.26C13.95 17.9 12.86 20 12 20zm4.86-0.88A15.9 15.9 0 0017.96 16h2.07a8.02 8.02 0 01-3.17 3.12zM8.5 12a11.3 11.3 0 01.13-1.5h6.74A11.3 11.3 0 0115.5 12c0 .5-.03 1-.13 1.5H8.63C8.53 13 8.5 12.5 8.5 12z"/>
          </svg>
          srlaptopbd.com
        </div>
      </div>
    ...
    <div class="flex pt-4 justify-center mt-8 no-print border-t border-gray-300">
      <button onclick="window.print()" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg shadow-lg flex items-center transition duration-300">
