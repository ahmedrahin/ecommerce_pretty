    ...
    <div class="modal-dialog modal-dialog-centered mw-1000px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">
                    {{ $edit_mode ? 'Update Role' : 'Add New Role' }}
                </h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                ...
                <form id="kt_modal_update_role_form" class="form" action="#" wire:submit.prevent="submit">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-solid @error('name') error-border @enderror" placeholder="Enter a role name" name="name" wire:model.defer="name"/>
                            <!--end::Input-->
                            @error('name')
                    ...
                    <div class="text-center pt-7">
                        ...
                        <button type="submit" class="btn btn-primary" data-kt-brand-modal-action="submit" style="width: 200px !important;">
                            @if( !$edit_mode )
                                <span class="indicator-label" wire:loading.remove wire:target="submit">Add Role</span>
                            @else
...
@push('scripts')
    <script>
        const closeModal = document.querySelector('#kt_modal_update_role');
