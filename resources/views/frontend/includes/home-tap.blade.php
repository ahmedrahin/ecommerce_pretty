 <div class="flat-spacing flat-animate-tab pt-0">
    <div class="container">
        <div class="sect-title wow fadeInUp">
            <div class="h1 title text-center mb-24">Shop By Departments</div>
            <ul class="tab-product_list" role="tablist">
                <li class="nav-tab-item" role="presentation">
                    <a href="#new-arrivals" data-bs-toggle="tab" class="tf-btn-line tf-btn-tab active"> NEW ARRIVALS </a>
                </li>
                <li class="nav-tab-item" role="presentation">
                    <a href="#trending" data-bs-toggle="tab" class="tf-btn-line tf-btn-tab"> TRENDING </a>
                </li>
                <li class="nav-tab-item" role="presentation">
        ...
        <div class="tab-content">
            <div class="tab-pane active show" id="new-arrivals" role="tabpanel">
